...
/*
    LightingCommon.hlsli는 조명 계산에 쓰는 공용 함수를 제공합니다.
    ...
    - u#: Compute/후처리용 UAV
    - 이 파일에서 직접 선언한 슬롯: t6, t7, t8, b2
*/

#ifndef LIGHTING_COMMON_HLSLI
#define LIGHTING_COMMON_HLSLI

#include "../Surface/CommonTypes.hlsli"
#include "LightingUnlit.hlsli"
#include "LightingGouraud.hlsli"
#include "LightingLambert.hlsli"
#include "LightingBlinnPhong.hlsli"
